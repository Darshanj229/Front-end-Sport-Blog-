...
export class PostapiService {
  ...
  allPostURL="http://localhost:8080/api/sportblog/posts";
  signupURL="http://localhost:8080/api/sportblog/signup"; 
  loginURL="http://localhost:8080/api/sportblog/login";   
  postsByCategoryURL="http://localhost:8080/api/sportblog/posts/";   
  singlePostURL="http://localhost:8080/api/sportblog/post/";
  getCommentsURL="http://localhost:8080/api/sportblog/comment/";  
  addCommentURL="http://localhost:8080/api/sportblog/comment/"; 
  addPostURL="http://localhost:8080/api/sportblog/post/"; 
  deletePostURL="http://localhost:8080/api/sportblog/post/"; 
  updatePostURL="http://localhost:8080/api/sportblog/post/"; 
  postsByUserIdURL="http://localhost:8080/api/sportblog/post/user/"; 
  getAllCommentsURL="http://localhost:8080/api/sportblog/comments";
  getCommentsByUserIdURL="http://localhost:8080/api/sportblog/comment/user/";
  deleteCommentByCommentIdURL="http://localhost:8080/api/sportblog/comment/";
  getCommentByCommentIdURL="http://localhost:8080/api/sportblog/getcomment/";
  updateCommentURL="http://localhost:8080/api/sportblog/comment/";
  getAllUsersURL="http://localhost:8080/api/sportblog/users";
  deteleUSerURL="http://localhost:8080/api/sportblog/user/";
  postSearchURL="http://localhost:8080/api/sportblog/post/search/";
